        ...
        <x-section title="Our Team">
            ...
            <div class="grid grid-cols-12 gap-3 mt-12">
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 flex flex-col flex-wrap bg-white">
                    <div>
                        <img src="images/tonya.png" alt="Tonya Goulding, Owner/Founder">
                    </div>
                    <div>
                        <div class="p-4 font-mont bg-white">
                            <div class="text-xl font-bold mb-2">Tonya Goulding</div>
                            <div class="text-xs tracking-wide mb-1">Owner/Founder</div>
                            <div class="text-xs tracking-wide mb-1">Licensed Esthetician</div>
                            <div class="text-xs tracking-wide mb-1">AIIC Master Certified Permanent Makeup Artist</div>
                            <div class="text-xs tracking-wide mb-1">Certified Permanent Makeup Trainer</div>
                            <div class="text-xs tracking-wide mb-1">Certified Permanent Makeup Trainer</div>
                            <div class="text-xs tracking-wide mb-1">Certified Dermaplane Pro Trainer</div>
                            <div class="text-xs tracking-wide mb-1">Skincare Specialist</div>
                        </div>
                    </div>
                </div>
